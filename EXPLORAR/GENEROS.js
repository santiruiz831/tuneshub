...
fetch('https://cors-anywhere.herokuapp.com/https://api.deezer.com/genre')
    ...
    genre.forEach(function(dataGenre){
        esqueleto.innerHTML +=  `<a href="" style="text-decoration: none;"><div style="margin-bottom: 20px;"><img id="fotogenero"; style="margin-right: auto; display:block; border-radius: 30%;margin-left: auto;" src="`+ dataGenre.picture_medium +`" alt="">
